...
public class VoGenerater extends AbstractGenerater {
	...
	protected String building() {
		...
		sb.append("\tprivate " + basicData.getUpperCaseDomainName() + " " + basicData.getLowerCaseDomainName() + ";\n\n");
		sb.append("\tpublic " + basicData.getUpperCaseDomainName() + " get" + basicData.getUpperCaseDomainName() + "() {\n");
		sb.append("\t\treturn " + basicData.getLowerCaseDomainName() + ";\n");
		sb.append("\t}\n\n");

		sb.append("\tpublic void set" + basicData.getUpperCaseDomainName() + "(" + basicData.getUpperCaseDomainName() + " "
				+ basicData.getLowerCaseDomainName() + ") {\n");
		sb.append("\t\tthis." + basicData.getLowerCaseDomainName() + " = " + basicData.getLowerCaseDomainName() + ";\n");
		sb.append("\t}\n\n");

		sb.append("\t@Override\n");
		sb.append("\tpublic String toString() {\n");
		sb.append("\t\treturn super.toString() + \"" + basicData.getUpperCaseDomainName() + "VO [" + basicData.getLowerCaseDomainName()
				+ "=\" + " + basicData.getLowerCaseDomainName() + " + \"]\";\n");
		sb.append("\t}\n");
		sb.append("}\n");
		return sb.toString();
