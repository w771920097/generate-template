...
public class ControllerGenerater extends AbstractGenerater {
  ...
  protected String building() {
    ...
    sb.append("\t@Autowired\n");
    sb.append("\tprivate " + basicData.getUpperCaseDomainName() + "Service "
        + basicData.getLowerCaseDomainName() + "Service;\n\n");
    ...
    // mode=edit
    sb.append(
        "\t\t}else if(DialogMode.EDIT_MODE.equals(mode) || DialogMode.VIEW_MODE.equals(mode)) {\n");
    sb.append("\t\t\tmodelMap.put(\"" + basicData.getLowerCaseDomainName() + "\", "
        + basicData.getLowerCaseDomainName() + "Service.get" + basicData.getUpperCaseDomainName()
        + "ById(id));\n");
    // mode=search
    sb.append("\t\t}else if(DialogMode.SEARCH_MODE.equals(mode)) {\n");
    sb.append("\t\t\t//TODO 设置路径\n");
    sb.append("\t\t\treturn \"/base/" + basicData.getLowerCaseDomainName() + "/search"
        + basicData.getUpperCaseDomainName() + "Dlg\";\n");
    sb.append("\t\t}\n");
    sb.append("\t\t//TODO 设置路径\n");
    sb.append("\t\treturn \"/base/" + basicData.getLowerCaseDomainName() + "/"
        + basicData.getLowerCaseDomainName() + "Dlg\";\n");
    sb.append("\t}\n\n");
    ...
    sb.append("\t\treturn \"/base/" + basicData.getLowerCaseDomainName() + "/"
        + basicData.getLowerCaseDomainName() + "List\";\n");
    sb.append("\t}\n");
    sb.append("\n");
    ...
    sb.append("\tpublic " + basicData.getUpperCaseDomainName() + " add"
        + basicData.getUpperCaseDomainName() + "(@ModelAttribute "
    ...
    // deleteByIds
    sb.append(
        "\t@RequestMapping(value = \"/delete" + basicData.getUpperCaseDomainName() + "ByIds\")\n");
    sb.append("\t@ResponseBody\n");
    sb.append("\tpublic Boolean delete" + basicData.getUpperCaseDomainName()
        + "ByIds(@RequestParam(value = \"ids[]\", required = true) Long[] ids) {\n");
    sb.append("\t\t" + basicData.getLowerCaseDomainName() + "Service.delete"
    ...
    // findForPageHelper
    sb.append(
        "\t@RequestMapping(value = \"/find" + basicData.getUpperCaseDomainName() + "List\")\n");
    sb.append("\t@ResponseBody\n");
    ...
    sb.append("\t\t\t\t" + basicData.getLowerCaseDomainName() + "Service.find"
        + basicData.getUpperCaseDomainName() + "ForPageHelper(" + basicData.getLowerCaseDomainName()
        + "VO));\n");
