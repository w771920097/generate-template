...
public class DomainNameValidatorGenerater extends AbstractGenerater {
  ...
  protected String building() {
    ...
    sb.append("public class " + basicData.getUpperCaseDomainName()
        + "Validator implements DomainValidator<" + basicData.getUpperCaseDomainName() + "> {\n");
    sb.append("\n");
    sb.append("\t@Override\n");
    sb.append("\tpublic ValidateResult validate(Integer validateMode,"
