...
public class BaseServiceImplGenerater extends AbstractGenerater {
  ...
  protected String building() {
    ...
    sb.append("\t@Override\n");
    sb.append(
        "\tpublic Boolean delete" + basicData.getUpperCaseDomainName() + "(Long... ids) {\n");
    sb.append("\t\tif (null == ids || ids.length == 0) {\n");
    sb.append("\t\t\tthrow new BusinessValidationException(\"删除" + basicData.getDomainCname()
        + "参数有误\");\n");
    sb.append("\t\t}\n");
    sb.append("\t\ttry {\n");
    sb.append("\t\t\tint count = " + basicData.getLowerCaseDomainName() + "Mapper.delete"
        + basicData.getUpperCaseDomainName() + "(ids);\n");
    ...
    sb.append("\t\t\tList<" + basicData.getUpperCaseDomainName() + "> list = "
        + basicData.getLowerCaseDomainName() + "Mapper.queryForPageInfo(" + basicData.getLowerCaseDomainName() + "VO.get"
