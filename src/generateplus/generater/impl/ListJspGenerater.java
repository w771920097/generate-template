...
public class ListJspGenerater extends AbstractGenerater {
	...
	protected String building() {
		...
		sb.append("\t\t\theight:$(document).height()-$(\"div.manage-area-title\").height()-$(\"#" + basicData.getDomainName()
				+ "Button\").height()-138,\n");
		...
		sb.append("\t\t\t\turl:\"/" + basicData.getDomainName() + "/find" + basicData.getUpperCaseDomainName() + "List\",\n");
		...
		sb.append("\t\t\t$.ajax({\n");
		sb.append("\t\t\t\turl:'/" + basicData.getDomainName() + "/delete" + basicData.getUpperCaseDomainName() + "ByIds',\n");
		sb.append("\t\t\t\tdata:{\n");
		...
		sb.append("\t\t\tif(null != $(\"#" + basicData.getDomainName() + "List\").getGridParam(\"selrow\")){\n");
		...
		sb.append("\t\t\treturn $(\"#" + basicData.getDomainName() + "List\").jqGrid(\"getGridParam\", \"selarrrow\");\n");
		sb.append("\t\t}\n");
		sb.append("\t});\n");
		sb.append("</script>\n");
