...
public class JavaMapperGenerater extends AbstractGenerater {
	...
	protected String building() {
		...
		sb.append("\t */\n");
		sb.append("\tvoid add" + basicData.getUpperCaseDomainName() + "(" + basicData.getUpperCaseDomainName() + " "
		...
		sb.append("\t * @return void    返回类型 \n");
		sb.append("\t */\n");
		sb.append("\tvoid update" + basicData.getUpperCaseDomainName() + "(" + basicData.getUpperCaseDomainName() + " "
				+ basicData.getLowerCaseDomainName() + ");\n\n");
		...
		sb.append("\t */\n");
		sb.append("\tList<" + basicData.getUpperCaseDomainName() + "> find" + basicData.getUpperCaseDomainName() + "ForList("
