...
public class XmlMapperGenerater extends AbstractGenerater {
	...
	public String building() {
		...
		String namespace = String.format("%s.mapper.%sMapper", basicData.getClassPath(), basicData.getUpperCaseDomainName());
		sb.append("<mapper namespace=\"").append(namespace).append("\">\n");
		sb.append("\t<resultMap id=\"").append(basicData.getLowerCaseDomainName()).append("Result\" type=\"")
				.append(basicData.getClassPath()).append(".domain.").append(basicData.getUpperCaseDomainName()).append("\">\n");
		for (String column : basicData.getColumns()) {
			sb.append("\t\t<result property=\"" + CommentUtil.replaceUnderlineAndfirstToUpper(column) + "\" column=\""
					+ column + "\"/>\n");
		}
		sb.append("\t</resultMap>\n\n");
		...
		// add
		sb.append("\t<insert id=\"add" + basicData.getUpperCaseDomainName() + "\" parameterType=\"" + basicData.getClassPath() + ".domain."
		...
		sb.append("\t<select id=\"get" + basicData.getUpperCaseDomainName()
				+ "ById\" parameterType=\"java.lang.Long\" resultMap=\"" + basicData.getLowerCaseDomainName() + "Result\">\n");
		sb.append("\t\tSELECT\n");
		...
		// update
		sb.append("\t<update id=\"update" + basicData.getUpperCaseDomainName() + "\" parameterType=\"" + basicData.getClassPath()
				+ ".domain." + basicData.getUpperCaseDomainName() + "\">\n");
		...
		// findForList
		sb.append("\t<select id=\"find" + basicData.getUpperCaseDomainName() + "ForList\" resultMap=\"" + basicData.getLowerCaseDomainName()
				+ "Result\"\n");
		sb.append("\t\tparameterType=\"" + basicData.getClassPath() + ".domain." + basicData.getUpperCaseDomainName() + "\">\n");
		sb.append("\t\tSELECT\n");
		sb.append("\t\t<include refid=\"columns\" />\n");
