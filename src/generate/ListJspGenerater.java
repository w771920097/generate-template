...
public class ListJspGenerater extends AbstractGenerater{
  ...
  public ListJspGenerater(String domainName, String domainCname, Map<String, String> columnsMap) {
  ...
  public String building() {
    ...
    //按钮
    sb.append("\t\t\t\t\t<pop:permissionTag ename=\"add"+getUpperCaseDomainName()+"\">\n");
    sb.append("\t\t\t\t\t\t<button id=\"add\" type=\"button\" class=\"tc-15-btn m\">新增</button>\n");
    sb.append("\t\t\t\t\t</pop:permissionTag>\n");
    sb.append("\t\t\t\t\t<pop:permissionTag ename=\"delete"+getUpperCaseDomainName()+"\">\n");
    sb.append("\t\t\t\t\t\t<button id=\"delete\" type=\"button\" class=\"tc-15-btn m\">删除</button>\n");
    sb.append("\t\t\t\t\t</pop:permissionTag>\n");
    sb.append("\t\t\t\t\t<pop:permissionTag ename=\"update"+getUpperCaseDomainName()+"\">\n");
    ...
    sb.append("\t\t\t\t<table id=\""+getDoMainName()+"List\"> </table>\n");
    sb.append("\t\t\t\t<div id=\""+getDoMainName()+"ListPager\"></div>\n");
    sb.append("\t\t\t</div>\n");
    sb.append("\t\t\t<div id=\""+getDoMainName()+"Dialog\"></div>\n");
    sb.append("\t\t</div>\n");
    sb.append("\t</div>\n");
    sb.append("</div>\n");
    ...
    sb.append("\t\t\t}\n");
    sb.append("\t\t};\n");
    sb.append("\t\t$(\"#"+getDoMainName()+"List\").jqGridFunction({\n");
    ...
    for (int i = 0; i < columns.size(); i++) {
      ...
      if(!"id".equals(field)){
        ...
        sb.append("\t\t\t\t\t\t {name : \""+field+"\",index : \""+column+"\",label:'"+field+"',sortable : true,align : 'center'},\n");
      }
    }
    sb.append("\t\t\t],\n");
    ...
    sb.append("\t\t\theight:$(document).height()-$(\"div.manage-area-title\").height()-$(\"#"+getDoMainName()+"Button\").height()-138,\n");
    sb.append("\t\t\tonSelectRow : function() {\n");
    sb.append("\t\t\t},\n");
    sb.append("\t\t\tondblClickRow: show"+getUpperCaseDomainName()+"\n");
    sb.append("\t\t});\n");
    
    //查看 方法
    sb.append("\t\tfunction show"+getUpperCaseDomainName()+"(rowId){\n");
    sb.append("\t\t\t$('#"+getDoMainName()+"Dialog').createDialog({\t  \n");
    sb.append("\t\t\t\twidth: 600,\t\t\t\t\t\t\t\n");
    sb.append("\t\t\t\theight: 500,\n");
    sb.append("\t\t\t\ttitle:'查看"+getDomainCname()+"',\n");
    sb.append("\t\t\t\turl:'/"+getDoMainName()+"/dispatch?mode=view&id='+rowId,\t \n");
    sb.append("\t\t\t\tbuttons: {\n");
    ...
    for (String field : fields) {
      if ("name".equals(field)){
        sb.append("\t\t\t\t\""+getDoMainName()+".name\":text\n");
        hasName = true;
      }
    }
    if (!hasName){
      sb.append("\t\t\t\t\""+getDoMainName()+".id\":1\n");
    }
    
    sb.append("\t\t\t}\n");
    sb.append("\t\t\t$(\"#"+getDoMainName()+"List\").setGridParam({\n");
    sb.append("\t\t\t\turl:\"/"+getDoMainName()+"/find"+getUpperCaseDomainName()+"List\",\n");
    sb.append("\t\t\t\tdatatype: \"json\",\n");
    sb.append("\t\t\t\tpage:1\n");
    sb.append("\t\t\t});\n");
    sb.append("\t\t\t$(\"#"+getDoMainName()+"List\").setPostData(initParam);\n");
    sb.append("\t\t\t$(\"#"+getDoMainName()+"List\").trigger(\"reloadGrid\");\n");
    sb.append("\t\t}\n");
    sb.append("\t\t\n");
    sb.append("\t\tonLoad();\n");
    sb.append("\t\t\n");
    ...
    sb.append("\t\t\t\twidth: 600,\t\t\t\t\t\t\t\n");
    sb.append("\t\t\t\theight: 500,\n");
    sb.append("\t\t\t\ttitle:'新增"+getDomainCname()+"',\n");
    sb.append("\t\t\t\turl:'/"+getDoMainName()+"/dispatch?mode=add',\t \n");
    sb.append("\t\t\t\tbuttons: {\n");
    ...
    sb.append("\t\t\tvar selectedIds = $(\"#"+getDoMainName()+"List\").jqGrid(\"getGridParam\", \"selarrrow\");\n");
    ...
    sb.append("\t\t\t\treturn;\n");
    sb.append("\t\t\t}\n");
    sb.append("\t\t\tshow"+getUpperCaseDomainName()+"(selectedIds);\n");
    sb.append("\t\t});\n");
    sb.append("\t\t\n");
    ...
    sb.append("\t\t\t\twidth: 600,\t\t\t\t\t\t\t\n");
    sb.append("\t\t\t\theight: 500,\n");
    sb.append("\t\t\t\ttitle:'修改"+getDomainCname()+"',\n");
    sb.append("\t\t\t\turl:'/"+getDoMainName()+"/dispatch?mode=update&id='+selectedIds,\t \n");
    sb.append("\t\t\t\tbuttons: {\n");
    sb.append("\t\t\t\t\t\"保存\" : function(){\n");
    sb.append("\t\t\t\t\t\t$(\"#maintainForm\").submit();\n");
    sb.append("\t\t\t\t\t},\n");
    ...
    sb.append("\t\t\t$.ajax({\n");
    sb.append("\t\t\t\turl:'/"+getDoMainName()+"/delete"+getUpperCaseDomainName()+"ByIds',\n");
    sb.append("\t\t\t\tdata:{\n");
    ...
    sb.append("\t\t\tif(null != $(\"#"+getDoMainName()+"List\").getGridParam(\"selrow\")){\n");
    ...
    sb.append("\t\t\treturn $(\"#"+getDoMainName()+"List\").jqGrid(\"getGridParam\", \"selarrrow\");\n");
    sb.append("\t\t}\n");
    sb.append("\t});\n");
    sb.append("</script>\n");
